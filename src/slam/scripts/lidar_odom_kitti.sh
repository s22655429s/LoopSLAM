...
gnome-terminal -x zsh -c "echo $seq;roslaunch slam odom_kitti.launch res_dir:=$1 seq:=${seq} >$logfile &sleep 5s;rosbag play --clock /home/whu/data/data_source_KITTI/velostereobag/velo_img_${seq}.bag -r 1.0;echo $seq over&&sleep 25s;exit"
i=10#$seq
